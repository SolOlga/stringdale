...
# %% auto 0
__all__ = ['logger', 'json_openai_client', 'raw_openai_client', 'mcp_tools_to_openai_kwargs', 'mcp_tools_to_anthropic_kwargs',
           'complete_anthropic', 'complete_raw', 'complete', 'answer_question', 'choose', 'choose_many', 'clean_model',
           'structured_output', 'User', 'Chat', 'image_to_text', 'speech_to_text']
